...
![Table Visualising the XML data-set in browser web-app](assets/README/data_table.gif)

I have taken inspiration in terms of design from the following:
![Web-app Example Photo](assets/README/Inspiration.png)
